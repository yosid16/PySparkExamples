...
def get_spark_session():
    #On windows
    os.environ["PYSPARK_DRIVER_PYTHON"] = "C:\\Progra~1\\Python36\\python.exe"
    os.environ["PYSPARK_PYTHON"] = "C:\\Progra~1\\Python36\\python.exe"
    os.environ["SPARK_HOME"] = "C:\Progra~1\Python36\Lib\site-packages\pyspark"
    os.environ["HADOOP_HOME"] = "C:\\tools\\"
